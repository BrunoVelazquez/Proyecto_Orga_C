...
void a_sub_arbol(tArbol arbol, tNodo nodo, tArbol * sa){
    ...
    tLista hermanos = nodo->padre->hijos;                               //Buscar hermanos de nueva subraiz
    tPosicion posicion_nodo_subraiz = buscar_posicion_nodo(nodo);       //Buscar posicion de nueva subraiz en lista de hermanos
